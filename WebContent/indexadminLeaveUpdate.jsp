...
<table align="center" cellpadding="10">
		...
		while(rs.next()){
			...
			%>
			<input type="hidden" name="id" value ='<%=rs.getString("EmpId")%>'>
		...
		<tr>
			...
			<td>
				<select name = "status" value ='<%=rs.getString("Status")%>'>
					...
					<option>Appproved</option>	
					<option>Reject</option>		
				</select>		
			<tr>
			<td align="center" colspan="2"><input type="submit"  class= "btn btn-success" name = "Update">
			</td>
		</tr>
